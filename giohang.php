...
<div class="cart-container">
    ...
    <div class="cart-right">
        ...
        <div class="policy-box">
            ...
            <p>✔ Miễn phí giao hàng – Áp dụng đơn hàng từ 250K trong khu vực nội thành</p>
        </div>
        ...
        <div class="policy-box">
            ...
            <p>✔ Giảm giá & khuyến mãi áp dụng khi thanh toán.</p>
            <p>✔ Sản phẩm chỉ được xác nhận khi thanh toán thành công.</p>
            <p>✔ Hãy kiểm tra chính xác số lượng trước khi thanh toán.</p>
        </div>
...
selectAll.addEventListener("change", function () {
    items.forEach(item => {
        item.querySelector(".item-check").checked = this.checked;
    });
    updateTotal();
});
