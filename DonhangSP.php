...
<link rel="stylesheet" href="DonhangSP.css">
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="table-section">
                <div class="table-header">
                    <div class="tabs">
                        <button class="tab active" onclick="location.href='DonhangSP.php'">Chờ xác nhận (45)</button>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button class="btn-confirm">Xác nhận đơn</button>
