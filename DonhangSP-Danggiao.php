...
<link rel="stylesheet" href="DonhangSP-Danggiao.css">
</head>
<body>
            ...
            <div class="table-section">
                <div class="table-header">
                    <div class="tabs">
                        ...
                        <button class="tab active" onclick="location.href='DonhangSP-Danggiao.php'">Đang giao</button>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button class="btn-confirm">Xem hành trình</button>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn-delivered">Đã giao</button>
                                <button class="btn-delete">🗑️</button>
                            </td>
                        </tr>
                        <tr>
